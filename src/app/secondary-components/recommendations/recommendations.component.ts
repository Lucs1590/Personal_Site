...
export class RecommendationsComponent {
  ...
  recommendations = [
    ...
    },
    {
      ...
      text: 'Foi e sempre será um prazer dividir uma mesa de trabalho com ele. Uma pessoa dedicada, que tem um ótimo espírito competitivo e que ama desafios. Esse seu estilo sempre motiva os colegas de trabalho a fazer o seu melhor.',
