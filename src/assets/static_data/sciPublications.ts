export const sciPublications = [
    {
        title: 'Rust (Hemileia Vastatrix) and Leaf Miner (Leucoptera Coffeella) in Coffee Crop (Coffea Arabica)',
        description: '<p>This dataset was used in a research paper called "Artificial intelligence for detection and quantification of rust and leaf miner in coffee crop", where we propose an algorithm and a mobile application to detect Rust and Leaf Miner in coffee leaves. We manually collected and labeled the images from a farm in Brazil, totalizing 285 images of the rust and 257 of the miner. The images are in the original captured resolution of 4000x2250 pixels. We used a simple smartphone camera to capture the images in RGB color system, and most parts of the photos were taken in a laboratory with a white background.</p>',
        thumbnail: '../../../assets/img/publications/rust_leaf_miner.png',
        pubDate: '2020/11/20',
        link: 'https://data.mendeley.com/datasets/vfxf4trtcg/5',
        author: 'SILVA, L. Brito; CARNEIRO, AL Cavalcante; FAULIN, Marisa Silveira Almeida Renaud.',
        categories: [],
        content: '',
        venue: 'Mendeley Data',
        year: 2020,
